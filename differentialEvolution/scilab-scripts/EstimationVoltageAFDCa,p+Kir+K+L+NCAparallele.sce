...
function [bM, valBest, costVec]=simulation(NP,itermax,F,CR)
    ...
    Xmin=[0.0001 0.0001 0.0001 0.0001 0.0001 20  -100 -90 20  -90 -90 -90 -90 1  -30 1  -30 0.0001 0.0001 0.0001 0.001 0.001 0.001 0.001];
    Xmax=[50     50     50     50     50     150 -2   30  150 -2  -2  -2  -2  30 -1  30 -1  15     15     15     0.999 0.999 0.999 10];
