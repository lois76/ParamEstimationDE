...
A=csvRead("/scilab-scripts/6differentRamps_BenchmarkLinear2.txt");
//A=csvRead("/home/naudin/Documents/article_ramp_current/Fichier Scilab/6differentRamps_BenchmarkLinear2.txt");
...
// Ramp current from stim_start to stim_fin during duration 
