...
function [Hdot]=HH22(t,x,pa)
    Hdot=zeros(2,1);
    Hdot(1)=(1/pa(9))*(-pa(1)*x(2)*(x(1)-pa(3))-pa(2)*(x(1)-pa(4))+I)
    Hdot(2)=(xinf(x(1),pa(5),pa(6))-x(2))/pa(7)
endfunction
...
//    costVec=zeros(1,itermax);
    ...
    Xmin=[0.1 0.1 -100 -90 -90 1   0.0001 0.001 0.001];
    Xmax=[50  50  -2   30  -2  30  15     0.999 10];
