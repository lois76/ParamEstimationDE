...
V12x1=-23.8; V12x2=-37.2; V12x3=-25.1;
kx1=18.4; kx2=-27.8; kx3=16.3;
tx1=2; tx2=5; tx3=9;
x10=0.3; x20=0.2; x30=0.1;
C=0.4;
...
for i=1:11
    I=stim(i);
    x=ode([-40; x10; x20; x30],t0,t,HH11ref);
    x1=x(1,:);
    x1=x1';
    a(:,i)=x1;
    plot2d(t,x1,2)
...
function [Hdot]=HH11est(t,x,pa)
    Hdot=zeros(4,1);
    Hdot(1)=(1/pa(19))*(-pa(1)*x(2)*x(3)*(x(1)-pa(4))-pa(2)*x(4)*(x(1)-pa(5))-pa(3)*(x(1)-pa(6))+I)
