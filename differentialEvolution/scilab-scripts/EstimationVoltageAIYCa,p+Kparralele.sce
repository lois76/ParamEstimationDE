...
function [Hdot]=HH12(t,x,pa)
    Hdot=zeros(3,1);
    Hdot(1)=(1/pa(13))*(-pa(1)*x(2)*(x(1)-pa(3)) - pa(2)*x(3)*(x(1)-pa(4)) + I)
...
//    costVec=zeros(1,itermax);
    ...
    Xmin=[0.1 0.1 20  -100 -90 -90  1  1   0.0001 0.0001 0.001 0.001 0.001];
    Xmax=[50  50  150 -2   -2  -2   30 30  15     15     0.999 0.999 10];
