...
A=csvRead("/scilab-scripts/6differentRampWithStabilization_BenchmarkLinear2.txt");
//A=csvRead("/home/naudin/Documents/article_ramp_current/Fichier Scilab/6differentRampWithStabilization_BenchmarkLinear2.txt");
...
function [Hdot]=HHramp(t,x,pa,stim_start,stim_fin,duration)
    Hdot=zeros(4,1);
    Hdot(1)=(1/pa(22))*(-pa(1)*x(2)*x(3)*(x(1)-pa(5)) - pa(2)*xinf(x(1),pa(10),pa(14))*(x(1)-pa(6)) - pa(3)*x(4)*(x(1)-pa(6)) - pa(4)*(x(1)-pa(7)) + Iramp(stim_start,stim_fin,duration,t))
