...
function [Hdot]=HH22(t,x,pa)
    Hdot=zeros(2,1);
    Hdot(1)=(1/pa(12))*(-pa(1)*xinf(x(1),pa(6),pa(8))*(x(1)-pa(4))-pa(2)*x(2)*(x(1)-pa(4))-pa(3)*(x(1)-pa(5))+I)
    Hdot(2)=(xinf(x(1),pa(7),pa(9))-x(2))/pa(10)
endfunction
...
//    costVec=zeros(1,itermax);
    ...
    Xmin=[0.1 0.1 0.1 -100 -80 -100 -90 -30  1   0.0001 0.001 0.001];
    Xmax=[30  30  30  -2   30  -2  -2   -1   30  15     0.999 10];
