...
function [bM, valBest]=simulation(NP,itermax,F,CR)
    ...
    Xmin=[0.1 0.1 0.1 0.1 20  -90 -80 -90 -90 -90 -90 -90 1  -30 -30 1  -30 0.0001 0.0001 0.0001 0.0001 0.001 0.001 0.001 0.001 0.001];
...
[bM, valBest]=simulation(140,1,0.5,0.85)
