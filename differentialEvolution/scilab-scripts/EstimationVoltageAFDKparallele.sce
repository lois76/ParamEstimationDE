...
function [Hdot]=HH22(t,x,pa)
    Hdot=zeros(3,1);
    Hdot(1)=(1/pa(11))*(-pa(1)*x(2)*x(3)*(x(1)-pa(2)) + I)
    Hdot(2)=(xinf(x(1),pa(3),pa(5))-x(2))/pa(7)
    Hdot(3)=(xinf(x(1),pa(4),pa(6))-x(3))/pa(8)
endfunction
...
//    costVec=zeros(1,itermax);
    ...
    Xmin=[0.1 -100 -90 -90 1  -30  1  1  0.0001 0.001 0.001];
    Xmax=[50  -2   -2  -2  30 -1   15 15 0.999  0.999 10];
